...
export default async function BlogPostPage({
  ...
  return (
    <>
      <article className="bg-bb-charcoal py-16 lg:py-24">
        <div className="mx-auto max-w-3xl px-6">
          <Link
            href="/blog"
            className="inline-flex items-center gap-1 text-sm font-medium text-bb-blue transition-colors duration-fast ease-out hover:text-white"
          >
            <ArrowLeft size={16} aria-hidden="true" /> All posts
          </Link>

          <p className="mt-8 text-xs font-medium uppercase tracking-[0.2em] text-bb-blue">
            {post.category}
          </p>
          ...
          <p className="mt-1 text-sm text-gray-400">{post.date} &middot; Updated June 2026</p>
