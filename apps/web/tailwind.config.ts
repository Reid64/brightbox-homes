  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'sign-in': 'signIn 750ms cubic-bezier(0.34,1.56,0.64,1) both',
        'route-trace': 'routeTrace 1000ms cubic-bezier(0.65,0,0.35,1) both',
        'route-pulse': 'routePulse 2.6s ease-in-out infinite',
        'route-spark': 'routeSpark 2.8s cubic-bezier(0.45,0,0.55,1) infinite',
        'node-pop': 'nodePop 440ms cubic-bezier(0.34,1.56,0.64,1) both',
        'book-swing': 'bookSwing 850ms cubic-bezier(0.34,1.42,0.5,1) both',
