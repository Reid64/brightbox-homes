...
export default function ExpandableDuplexPage() {
  return (
    <div className="bg-bb-charcoal">
      {/* Hero: title/text left, image right - both above the fold */}
      <section className="bg-bb-surface-dark py-10 lg:py-16">
        <div className="mx-auto flex max-w-[1280px] flex-col gap-10 px-6 lg:flex-row lg:items-center">
          {/* Left: title, price, features, CTAs */}
