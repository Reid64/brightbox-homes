...
export default function DesignJourneyContent({ active }: { active: number }) {
  return (
    ...
    <div key={active} style={{ animation: 'fadeIn 200ms ease-out' }}>
      ...
      {active === 2 && (
        <div>
          <h1 className={heading}>Choose Your Roof Color</h1>
          <Image
          ...
          />
          <p className="mt-3 text-sm text-gray-300">24-gauge corrugated metal roofing in 19 standard colors.</p>
          ...
          <div className="mt-10 flex flex-col gap-6 sm:flex-row sm:items-start">
            <figure className="w-full max-w-[200px]">
              <Image
                ...
                alt="Standard metal roof truss"
                width={1499}
                height={1049}
                className="h-auto w-full rounded-lg border border-white/10 bg-white/5"
              />
              <figcaption className="mt-2 text-sm text-gray-300">Standard Truss</figcaption>
            </figure>
            <figure className="w-full max-w-[200px]">
              <Image
                src="/images/upgrades/metal-roof-truss-reinforced-solar.png"
                alt="Reinforced solar-ready metal roof truss"
                width={1500}
                height={1049}
                className="h-auto w-full rounded-lg border border-white/10 bg-white/5"
              />
              <figcaption className="mt-2 text-sm text-gray-300">Solar-Ready Truss</figcaption>
            </figure>
            <figure className="w-full max-w-[200px]">
              <video
                controls
              ...
              <figcaption className="mt-2 text-sm text-gray-300">Truss Installation</figcaption>
            </figure>
          </div>
        </div>
      )}
